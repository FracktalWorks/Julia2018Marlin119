 ...
 */
    ...
    #define MINIMUM_STEPPER_DIR_DELAY  2000
  #elif HAS_DRIVER(DRV8825)
    #define MINIMUM_STEPPER_DIR_DELAY   1500 //was 650
  ...
  #elif HAS_DRIVER(DRV8825)
    #define MINIMUM_STEPPER_PULSE  10 // was 2
  ...
  #elif HAS_DRIVER(DRV8825)
    #define MAXIMUM_STEPPER_RATE 200000 //was 250khz
  #elif HAS_TRINAMIC || HAS_DRIVER(TMC2660) || HAS_DRIVER(TMC2130_STANDALONE) || HAS_DRIVER(TMC2208_STANDALONE) || HAS_DRIVER(TMC26X_STANDALONE) || HAS_DRIVER(TMC2660_STANDALONE)
